...
"}")
        ...
        self.label_user_connection.setPixmap(QtGui.QPixmap(folder_img + "/" + "personne.png"))
        ...
        self.logo_6.setPixmap(QtGui.QPixmap(folder_img + "/" + "new_question.png"))
        ...
        self.label_img_subjet.setPixmap(QtGui.QPixmap(folder_img + "/" + "new_discussion-de-groupe.png"))
        ...
        self.logo_2.setPixmap(QtGui.QPixmap(folder_img + "/" + "new_chimie.png"))
        ...
        self.logo.setPixmap(QtGui.QPixmap(folder_img + "/" + "new_planete-terre.png"))
        ...
        self.logo_4.setPixmap(QtGui.QPixmap(folder_img + "/" +"new_eng.png"))
