...
"}")
        ...
        self.logo_6.setPixmap(QtGui.QPixmap(folder_img + "/" + "philosophie.png"))
        ...
        self.label_img_subjet.setPixmap(QtGui.QPixmap(folder_img + "/" + "groupe-de-discussion.png"))
        ...
        self.logo_2.setPixmap(QtGui.QPixmap(folder_img + "/" + "physique.png"))
        ...
        self.logo.setPixmap(QtGui.QPixmap(folder_img + "/" + "planète-terre.png"))
        ...
        self.logo_4.setPixmap(QtGui.QPixmap(folder_img + "/" +"traduction.png"))
